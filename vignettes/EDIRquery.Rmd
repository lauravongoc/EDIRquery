...
<!-- To query the full the database, obtain the files at `(insert link here)` and provide the data directory to `gene_lookup()` in the `path` parameter. -->
...
| path     | String containing path to directory holding downloaded dataset files. If not provided (`path` = NA), provided example subset of data will be used | NA      |
