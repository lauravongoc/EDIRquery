...
| length   | Repeat sequence length, must be between 7 and 20. If NA, results 
will include all available lengths in dataset for queried gene  | NA      |
...
files. If not provided (`path` = NA), provided example subset of data will be 
used | NA      |
